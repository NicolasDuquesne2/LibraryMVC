...
namespace LibraryMVC.Controllers
{
    public class AdressesController : Controller
    {
        ...
        public AdressesController(LibraryDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Appartement,Rue,Ville,CodePostal,Pays,Id")] Adresse adresse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Appartement,Rue,Ville,CodePostal,Pays,Id")] Adresse adresse)
        {
            if (id != adresse.Id)
            {
                return NotFound();
